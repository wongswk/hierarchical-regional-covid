...
province_wide <- t(as.matrix(colSums(daily_diffs)))
...
mprov <- fit_seeiqr(province_wide,
                 pop_size = pop_size,
...
saveRDS(mprov, file="data-generated/fit-predNov-provincewide-loosepriors-mode.rds")
