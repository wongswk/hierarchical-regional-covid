# Run the hierarchical multiregion model on simulated data
...
seed <- 12345
source("analysis/simulation-study.R")

daily_diffs <- rbind(sim_dat[[1]]$obs, sim_dat[[2]]$obs, sim_dat[[3]]$obs, sim_dat[[4]]$obs, sim_dat[[5]]$obs)
...
save(f2_prior, f3_prior, f4_prior, f5_prior, f6_prior, f7_prior, psi1pi, psi2pi, psi3pi, psi4pi, m7, daily_diffs, file=paste0("data-generated/fit-endDec-multiregion-sim-",seed,".rda"))
